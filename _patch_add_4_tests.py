...
NEW_ORIENTATION = BEGIN_O + r"""
  { code: "Raisonnement", name: "Test Raisonnement", model: "ICAR-Sample (cognition)", accent: "#1E88E5", accentSoft: "rgba(30,136,229,0.12)", href: "#bientot", bientot: true, duration: "12 min", questions: "12 questions", eyebrow: "Raisonnement cognitif", /* TODO: build dédié, multi-choice != Likert (engine séparé) */
  ...
  { code: "Grit", name: "Test Grit", model: "Grit-S (Duckworth)", accent: "#6B46C1", accentSoft: "rgba(107,70,193,0.12)", href: "./Proxxie Test Grit.html", duration: "5 min", questions: "8 questions", eyebrow: "Persévérance",
  ...
  { code: "CAAS", name: "Test Adaptabilité Carrière", model: "CAAS (Savickas)", accent: "#00897B", accentSoft: "rgba(0,137,123,0.12)", href: "./Proxxie Test CAAS.html", duration: "7 min", questions: "24 questions", eyebrow: "Adaptabilité au futur",
